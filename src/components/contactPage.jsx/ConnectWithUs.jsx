        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="p-8 bg-gradient-to-b from-gray-800 to-gray-900 rounded-xl shadow-sm border border-gray-700">
            ...
            {SocialsApi.map(function (items) {
              return <Socials socialMedia={items.socialMedia} socialIcon={items.socialIcon} socialHandle={items.socialHandle} index={items.index} socialName={items.socialName}/>;
            })}
          </div>
